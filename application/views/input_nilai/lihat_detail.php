	...
	<div class="container clearfix">
		...
		<style>
		 ...
		 <section id="portfolio">
			...
			<div class="container">
			<p align="right" style="margin-right: 10%; color: rgb(205, 216, 46); font-size: 20px; font-weight: bold; background-color: black; width: 100%; line-height: 200%; border-radius: 20px; padding-right: 10px;"><a href="<?= base_url()?>index.php/admin" align="right" style="color: rgb(0, 247, 255);">Home</a> > <a href="<?= base_url()?>index.php/input_nilai" align="right" style="color: rgb(0, 247, 255);">Daftar Input Nilai</a> > <a href="#" align="right" style="color: rgb(255, 255, 255);">Detail Penilaian</a></p>
				<br>
			...
			<form action="/action_page.php">
				...
				<legend style="font-size: 30px; height: auto; font-family: Arial, Helvetica, sans-serif; padding: 15px;">INFORMASI DETAIL</legend>
				...
				<br>
					<center><button type="button"  class="btn btn-primary btn-lg" ><a href="<?= base_url()?>index.php/input_nilai/" style="color: #ffffff;"><i class="fas fa-back"></i>KEMBALI</a></button></center>
