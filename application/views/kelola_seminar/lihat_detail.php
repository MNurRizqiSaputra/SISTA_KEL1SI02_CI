		...
		<style>
		 ...
		 <section id="portfolio">
			...
			<form action="/action_page.php">
				...
				<br>
					<center><button type="button"  class="btn btn-primary btn-lg" ><a href="<?= base_url()?>index.php/kelola_seminar/" style="color: #ffffff;"><i class="fas fa-back"></i>KEMBALI</a></button></center>
