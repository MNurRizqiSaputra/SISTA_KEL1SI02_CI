...
<div class="preloader_hide">
	...
	<div id="page">
        ...
        <br>
        <br>
        <p style="font-weight: bold; font-size: 40px; text-align: center;" >TIM CREATOR SISTA</p>
        <br>
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <br>
                   <center><table class="table-responsive" style="text-align: center; font-size: 15px; font-weight: bold;"></center>
                    <tr>
                        <td>NAMA</td>
                        <td>:</td>
                        <td>MUHAMMAD ADLI AZZAM</td>
                    </tr>
                    <tr>
                        <td>NIM</td>
                        <td>:</td>
