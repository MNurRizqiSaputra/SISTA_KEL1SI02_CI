	...
	<div id="page">
		...
		<style>
		 ...
		 <section id="portfolio">
			...
			<div class="container">
                              <p align="right" style="margin-right: 10%; color: rgb(205, 216, 46); font-size: 20px; font-weight: bold; background-color: black; width: 100%; line-height: 200%; border-radius: 20px; padding-right: 10px;"><a href="<?= base_url()?>index.php/admin" align="right" style="color: rgb(0, 247, 255);">Home</a> > <a href="<?= base_url()?>index.php/kelola_peserta" align="right" style="color: rgb(0, 247, 255);">Kelola Peserta</a> > <a href="#" align="right" style="color: rgb(255, 255, 255);">Detail Peserta</a></p>
				<br>
			<center><h1 style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">DETAIL PESERTA</h1></center>
			<br>
			<hr>
			<form action="/action_page.php">
				...
				<br>
					<center><button type="button"  class="btn btn-primary btn-lg" ><a href="<?= base_url()?>index.php/kelola_peserta/" style="color: #ffffff;"><i class="fas fa-back"></i>KEMBALI</a></button></center>
