...
<div class="container">
<br>
<p align="right" style="margin-right: 10%; color: rgb(205, 216, 46); font-size: 20px; font-weight: bold; background-color: black; width: 100%; line-height: 200%; border-radius: 20px; padding-right: 10px;"><a href="<?= base_url()?>" align="right" style="color: rgb(0, 247, 255);">Home</a> > <a href="#" align="right" style="color: rgb(255, 255, 255);">Jadwal</a></p>
<br>
<center><h1 style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">JADWAL SEMINAR <br> & <br> DAFTAR PESERTA</h1></center>
<div class="table-responsive">
		<center><table class="table" border="10" width="100%">
			<thead class="thead-dark"  style="background-image: linear-gradient(to right top, #4b12eb, #3511bf, #210d95, #11096c, #070146);  color: white;" >
				...
				<th scope="col" size="100px" height="70px" style="text-align: center; font-size: 20px;">KATEGORI SEMINAR</th>
				...
				<th scope="col" size="200px" height="70px" style="text-align: center; font-size: 20px;">DAFTAR PESERTA</th>
				</tr>
			</thead>
			<br>
			<br>
			...
			<tr style="font-family: Arial, Helvetica, sans-serif; text-align: center; font-size: medium; font-weight: bold;">
				...
				<td>
					<button type="button"  class="btn btn-primary btn-lg" ><a href="<?php echo base_url('index.php/jadwal_seminar/lihat_detail/'.$row->id);?>" style="color: #ffffff;"><i class="fas fa-search"></i> LIHAT DETAIL</a></button>
				</td>
				<td>
				<button type="button"  class="btn btn-primary btn-lg" ><a href="<?php echo base_url('index.php/jadwal_seminar/daftar_seminar/'.$row->id);?>" style="color: #ffffff;"><i class="fas fa-plus"></i> DAFTAR PESERTA</a></button>
				</td>
